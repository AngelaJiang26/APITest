...
const defaultdata = `'John', 'CDN', '80', 'Lisbon', 'FALSE', 'Caching', 'C++', 'AI'
...
const dataString = `'John', 'CDN', '80', 'Lisbon', 'FALSE', 'Caching', 'C++', 'AI'
'Jill', 'Developer Platform', '100', 'Austin', 'FALSE', 'Typescript', 'C++', 'GoLang'
'Audrey Leblanc', 'Accounting', '154', 'Singapore', 'TRUE', 'HTML', 'CSS', 'Postgres'
'Braden McMahon', 'Bots', '219', 'San Francisco', 'TRUE', 'Distributed Systems', 'Rust', 'AI'`;
...
const App = () => {
  return (
    <div style={{ marginTop: '40px', marginRight: '40px', marginBottom: '30px', marginLeft: '40px' }}>
      <h1>General Data for Employee</h1>
      <h2>Click on each column name to sort ascending/descending by that column name lexicographically</h2>
      
      <Chart className="full-table" dataString = {defaultdata}/>
    </div>
  );
};
